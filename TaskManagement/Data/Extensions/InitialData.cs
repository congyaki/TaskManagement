...
namespace TaskManagement.Data.Extensions
{
    internal class InitialData
    {
        ...
        {
            new() { Title = "Hoàn thành tài liệu dự án", Code = "NV_001", Description = "Chuẩn bị và hoàn tất tất cả tài liệu dự án.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(7), Priority = 1, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.NotAssigned },
            new() { Title = "Phát triển module xác thực", Code = "NV_002", Description = "Triển khai xác thực và phân quyền người dùng.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(14), Priority = 1, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Assigned },
            new() { Title = "Tối ưu hóa cơ sở dữ liệu", Code = "NV_003", Description = "Tối ưu hóa các truy vấn cơ sở dữ liệu để tăng hiệu suất.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(10), Priority = 2, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Received },
            new() { Title = "Đánh giá thiết kế giao diện", Code = "NV_004", Description = "Đánh giá thiết kế giao diện người dùng.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(3), Priority = 3, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.InProgress },
            new() { Title = "Viết kiểm thử đơn vị", Code = "NV_005", Description = "Viết các kiểm thử đơn vị cho các module cốt lõi.", StartDate = DateTime.Now.AddHours(-2), EndDate = DateTime.Now.AddHours(3), Priority = 1, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Completed },
            new() { Title = "Sửa lỗi", Code = "NV_006", Description = "Sửa các lỗi phát hiện trong giai đoạn kiểm thử.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(4), Priority = 1, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.InProgress },
            new() { Title = "Tái cấu trúc mã nguồn", Code = "NV_007", Description = "Tái cấu trúc mã nguồn để cải thiện khả năng đọc và hiệu suất.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(8), Priority = 2, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Tích hợp API", Code = "NV_008", Description = "Tích hợp các API của bên thứ ba.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(12), Priority = 1, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.UnStatisfactory },
            new() { Title = "Chuẩn bị báo cáo dự án", Code = "NV_009", Description = "Biên soạn và hoàn tất báo cáo dự án.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(6), Priority = 3, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Completed },
            new() { Title = "Kiểm toán bảo mật", Code = "NV_010", Description = "Thực hiện kiểm toán bảo mật cho các module.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(11), Priority = 2, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Thiết lập pipeline CI/CD", Code = "NV_011", Description = "Cấu hình tích hợp liên tục và triển khai liên tục.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(9), Priority = 1, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Viết tài liệu API", Code = "NV_012", Description = "Viết tài liệu cho các API.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(7), Priority = 3, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Tổ chức buổi đào tạo người dùng", Code = "NV_013", Description = "Tổ chức buổi đào tạo cho người dùng mới.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(2), Priority = 1, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Kiểm thử hiệu suất", Code = "NV_014", Description = "Kiểm thử hiệu suất hệ thống dưới tải cao.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(5), Priority = 2, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Lên ý tưởng tính năng mới", Code = "NV_015", Description = "Thảo luận và lên ý tưởng cho các tính năng mới với nhóm.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(1), Priority = 3, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Khắc phục giao diện không nhất quán", Code = "NV_016", Description = "Khắc phục các lỗi không nhất quán trong giao diện.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(6), Priority = 1, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Di chuyển cơ sở dữ liệu", Code = "NV_017", Description = "Di chuyển dữ liệu sang cấu trúc cơ sở dữ liệu mới.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(13), Priority = 2, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Cải thiện khả năng truy cập", Code = "NV_018", Description = "Cải thiện khả năng truy cập trong ứng dụng.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(4), Priority = 3, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Họp với khách hàng để phản hồi", Code = "NV_019", Description = "Thảo luận các phản hồi từ khách hàng.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(1), Priority = 1, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed },
            new() { Title = "Thiết lập công cụ giám sát", Code = "NV_020", Description = "Cài đặt giám sát và cảnh báo cho môi trường sản xuất.", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(10), Priority = 2, CreatedAt = DateTime.Now, CreatedBy = 0, Status = TaskStatus.Confirmed }
        };
